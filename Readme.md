...
For the third effect, Grand Theft Auto Drunk effect came into my mind. So by also using the environment to my favor I created a simple â€œdrunkenâ€? post processing that utilizes not only the global volume but also a UV distortion shader.
